...
#define minVelocidade 0.3       // limite inferior de velocidade do bixinho      
#define maxVelocidade 1.0       // limite superior de velocidade do bixinho
#define minRadius 0.03          // limite inferior do raio do bixinho
#define maxRadius 0.1           // limite superior do raio do bixinho
#define minPercep 0.3           // limite inferior do campo de percepção do bixinho
#define maxPercep 1.0           // limite superior do campo de percepção do bixinho
#define slowness 100            // fator de decréscimo da velocidade de simulação (valor adequado: 100) 
